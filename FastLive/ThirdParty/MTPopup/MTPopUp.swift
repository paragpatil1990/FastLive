...
//MARK: - Show Popup
    func show(complete : ((Int)->())? , view: UIView, animationType: NSString, strMessage: String,btnArray: NSArray, strTitle: String = "", themeColor: UIColor, textAlignment: NSTextAlignment)
    {
        ...
        for strBtnTitle in btnArray
        {
            ...
            btnOk.titleLabel?.textColor = UIColor.black
